...
* **Repository (repo)** → the project’s codebase stored locally (on your machine) and remotely (on GitHub).
...
✅ Best practice: Use **feature branches** (`feature/login-page`, `bugfix/cart-issue`) instead of working directly on `main`/`develop`.
